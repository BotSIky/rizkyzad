...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["IKY GANS", "Chrome", "3.0"];
  ...
  await client.connect({ timeoutMs: 30 * 2000 });
  fs.writeFileSync(
    "./session.json",
    JSON.stringify(client.base64EncodedAuthInfo(), null, "\t")
  );
        ownerNumber = ["6283102774416@s.whatsapp.net",`6283102774416@s.whatsapp.net`]
        dtod = "6283102774416@s.whatsapp.net"
       otod = `6283102774416@s.whatsapp.net`
  ...
  client.on('group-participants-update', async (anu) => {
		try {
			...
			if (anu.action == 'add') {
				...
				client.sendMessageo(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
...
fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6283136505591-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `${mdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;pemuda;;;\nFN:pemuda\nitem1.TEL;waid=6283102774416:6283102774416\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}
